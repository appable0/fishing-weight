...
def getFishingExpWeight(lvl, overflow):
    return ((lvl / 50) * 2500) + (10 * math.sqrt((overflow / 60000000) * 10000) - 1000)
...
class Mob:
    ...
    def calculate_sc_weight(self):
        ...
        total_weight = ms_weight + overflow_weight
        return total_weight
...
total_collection_weight = sum(coll_object.weight for coll_object in all_collections.values())
...
class Tfishi:
    ...
    def calculate_tfishi_rarity_weight(rarity, chance, rarity_scalar):
        if rarity > 1: return rarity_scalar * (1130/122114) + 0.15 * math.sqrt((rarity - 1) / (1 / rarity_scalar))
        elif rarity == 1: return rarity_scalar * (1130/122114)
        else: return 0
...
shark_festival_completion_weight = progress_shark_festival * 250

# treasure weight
treasure_weight = treasures_fished / 100
...
grand_total_weight = sum([
    total_fexp_weight, total_bestiary_weight, total_collection_weight, total_tfishi_weight, treasure_weight, shark_festival_completion_weight, dolphin_milestone_weight, unique_pet_weight
])
...
print('--------------------------------------------------')
print(f'Fishing Exp Weight: {round(total_fexp_weight)}')
print(f'Total Fishing BE Weight: {round(total_bestiary_weight)}')
print(f' | Water family: {round(water_family_weight)}')
print(f' | Lava family: {round(lava_family_weight)}')
print(f' | Spooky family: {round(spooky_family_weight)}')
print(f' | Shark family: {round(shark_family_weight)}')
print(f' | Winter family: {round(winter_family_weight)}')
print('')
print(f'Collection Weight: {round(total_collection_weight)}')
print(f'Trophy Fish Weight: {round(total_tfishi_weight)}')
print(f'Dolphin Pet MS Weight: {round(dolphin_milestone_weight)}')
print(f'Shark Festival Completion Weight: {round(shark_festival_completion_weight)}')
print(f'Treasure Weight: {round(treasure_weight)}')
print(f'Unique Pet Weight: {round(unique_pet_weight)}')
print('--------------------------------------------------')
print(f'Grand Total Weight: {round(grand_total_weight)}')
print('')
print('')
